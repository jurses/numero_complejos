...
public class Main extends Application{
	...
	public void start(Stage s)
	{
		...
		cb_operator.getSelectionModel().selectFirst();
		...
		tf_c1a.textProperty().bindBidirectional(dp_a1, new NumberStringConverter());
		tf_c1b.textProperty().bindBidirectional(dp_b1, new NumberStringConverter());
		tf_c2a.textProperty().bindBidirectional(dp_a2, new NumberStringConverter());
		tf_c2b.textProperty().bindBidirectional(dp_b2, new NumberStringConverter());
		tf_cra.textProperty().bindBidirectional(dp_ar, new NumberStringConverter());
		tf_crb.textProperty().bindBidirectional(dp_br, new NumberStringConverter());
		...
		cb_operator.valueProperty().addListener((o, ov, nv) -> {
			...
			{
			case "+":
				dp_ar.setValue(dp_a1.add(dp_a2).get());
				dp_br.setValue(dp_b1.add(dp_b2).get());
				break;
			case "-":
				dp_ar.setValue(dp_a1.subtract(dp_a2).get());
				dp_br.setValue(dp_b1.subtract(dp_b2).get());
				break;
			case "*":
				dp_ar.setValue(dp_a1.multiply(dp_a2).subtract(dp_b1.multiply(dp_b2)).get());
				dp_br.setValue(dp_a1.multiply(dp_b2).add(dp_b1.multiply(dp_a2)).get());
				break;
			case "/":
				dp_ar.setValue(dp_a1.multiply(dp_a2).add(dp_b1.multiply(dp_b2)).divide(dp_a2.multiply(dp_a2).add(dp_b2.multiply(dp_b2))).get());
				dp_br.setValue(dp_b1.multiply(dp_a2).subtract(dp_a1.multiply(dp_b2)).divide(dp_a2.multiply(dp_a2).add(dp_b2.multiply(dp_b2))).get());
				break;
			}
		});
